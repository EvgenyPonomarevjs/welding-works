...
const EMAIL_SETTINGS = [
  'addresses' => ['ponomareve45@gmail.com'], // кому необходимо отправить письмо
  'from' => ['speedjob@gmail.com', 'rastochkayug.ru'], // от какого email и имени необходимо отправить письмо
